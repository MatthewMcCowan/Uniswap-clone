...
const style = {
  wrapper: `h-full text-white select-none w-screen flex-1 pt-14 flex items-end justify-end pb-12 overflow-hidden px-8`,
      ...
      <section>
        {transactionHistory &&
          transactionHistory?.map((transaction, index) => (
            <section className={style.txHistoryItem} key={index}>
